...
const styles = StyleSheet.create({
  ...
  accountCardNameActive: { color: T.white },
  accountCardBalance: {
  ...
  saldoValue: { fontFamily: 'Poppins_100Thin', fontSize: 32, color: T.white, marginVertical: 4 },
  ...
  txDesc: { fontFamily: 'Poppins_400Regular', fontSize: 14, color: T.white },
  ...
  fabText: { fontSize: 28, color: T.white, fontFamily: 'Poppins_600SemiBold', marginTop: -2 },
});
