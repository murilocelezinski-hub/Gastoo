...
function createCreditCardsStyles(T, isDesktop) {
  return StyleSheet.create({
    ...
    errorBanner: { fontFamily: 'Poppins_400Regular', fontSize: isDesktop ? 14 : 13, color: T.burnt, marginBottom: 4 },
    row: {
      flexDirection: 'row',
      alignItems: 'center',
    ...
    rowIcon: { fontSize: isDesktop ? 32 : 26 },
    rowName: { fontFamily: 'Poppins_600SemiBold', fontSize: isDesktop ? 15 : 14, color: T.graphite },
    rowMeta: { fontFamily: 'Poppins_400Regular', fontSize: isDesktop ? 12 : 11, color: T.grayMed, marginTop: 2 },
    rowSub: { fontFamily: 'Poppins_400Regular', fontSize: isDesktop ? 11 : 10, color: T.grayNeutral, marginTop: 2 },
    ...
    rowFields: { flexDirection: 'row', gap: isDesktop ? 16 : 12 },
...
export default function CreditCardsScreen({ navigation }) {
  ...
  const styles = useMemo(() => createCreditCardsStyles(T, isDesktop), [T, isDesktop]);
